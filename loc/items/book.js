export default [{
  ...
  description: {
    ...
    fr: 'Effectuez des attaques de mélée automatiques avec votre arme.',
  }
},
{
  name: {$$: 'Slash'},
  ...
  description: {
    ...
    fr: 'Lacérez votre ennemi, en frappant avec une force supplémentaire. Vous soigne 5% des dégats infligés.',
  }
},
{
  name: {$$: 'Bulwark'},
  ...
  description: {
    ...
    fr: 'Augmentez vos chances de bloquer une attaque, tout en augmentant vos dégats pour chaque blocage réussi.',
  }
},
{
  name: {$$: 'Crescent Swipe'},
  ...
  description: {
    ...
    fr: 'Faites rapidement tourner votre épée autour de vous, endommageant les ennemies dans un rayon.',
  }
},
{
  name: {$$: 'Ice Bolt'},
  ...
  description: {
    ...
    fr: 'Tirez un projectile de glace vers votre ennemi. Réduit le temps de recharge d\'Icicle Orb de 0.5 secondes. Gèle les cibles jusqu\'à 5 charges, au cours desquelles elles seront étourdies et subiront 50% de dégats supplémentaires. Gagne un lancement instantané toutes les 7 secondes.',
  }
},
{
  name: {$$: 'Auto attack'},
  ...
  description: {
    ...
    fr: 'Attaquez automatiquement votre ennemi à distance.',
  }
},
{
  name: {$$: 'Mend'},
  ...
  description: {
    ...
    fr: 'Soignez une cible alliée. La quantité de soin est augmentée pour chaque charge de Revitalize.',
  }
},
{
  name: {$$: 'Revitalize'},
  ...
  description: {
    ...
    fr: 'Soignez une cible alliée sur une courte durée, cumulable jusqu\'à 3 fois tout en augmentant la puissance du Mend.',
  }
},
{
  name: {$$: 'Bloodline'},
...
},
{
  ...
  description: {
    ...
    fr: 'Vos Precise Shots passeront à des cibles supplémentaire tant que ce sort est actif.',
  }
},
{
  name: {$$: 'Invigorate'},
...
},
{
  ...
  description: {
    ...
    fr: 'Maudissez votre ennemi avec Decay, infligeant des dégats à l\'impact puis des dégats supplémentaires sur la durée.',
  }
},
{
  name: {$$: 'Mimir\'s Well'},
...
},
{
  ...
  description: {
    ...
    fr: 'Vous émettez une onde de choc glaciale autour de vous, infligeant des dégats et gelant les ennemis. Augmente les chances de critiques de certains de vos sorts.',
  }
},
{
  name: {$$: 'Icicle Orb'},
  ...
  description: {
    ...
    fr: 'Invoquez un grand orbe, ejectant des stalactites, frappant tous les ennemis sur son chemin.',
  }
},
{
...
},
{
  ...
  description: {
    ...
    fr: 'Quand actif, vous êtes soigné chaque fois que vous bloquez une attaque.',
  }
},
{
...
},
{
  ...
  description: {
    ...
    fr: 'Augmentez les dégats de votre cible.',
  }
},
{
...
},
{
  ...
  description: {
    ...
    fr: 'Tirez un Swift Shot, qui peut être amélioré s\'il est précédé d\'un Precise Shot.',
  }
},
{
  name: {$$: 'Teleport'},
  ...
  description: {
    ...
    fr: 'Téléportez-vous instantanément dans la direction à laquelle vous faites face.',
  }
},
{
  name: {$$: 'Charge'},
  ...
  description: {
    ...
    fr: 'Chargez vers n\'importe quelle cible tout en l\'étourdissant (si elle est hostile). La durée de l\'étourdissement augmente à mesure que la distance à la cible augmente.',
  }
},
{
  name: {$$: 'Taunt'},
  ...
  description: {
    ...
    fr: 'Provoquez les ennemis aux alentours, les forçant à se déplacer vers vous pendant un bref instant. Interrompt les lancements de sort et réinitialise l\'aggro pour tous les monstres.',
  }
},
{
  name: {$$: 'Summon'},
  ...
  description: {
    ...
    fr: 'Ivoquez les membres du groupe, leur permettant de se téléporter instantanément à vous.',
  }
},
{
  name: {$$: 'Spirit Animal'},
  ...
  description: {
    ...
    fr: 'Transformez-vous en votre animal spirituel pour obtenir de la vitesse de déplacement supplémentaire, supprimant tous les effets actifs altérant le mouvement au moment de la transformation. Tout lancer de sorts annulera cet effet.',
  }
},
{
  name: {$$: 'Agonize'},
...
},
{
  ...
  description: {
    ...
    fr: 'Vous vous précipitez dans votre direction actuelle, réinitialisant instantanément le temps de recharge de Precise Shot. Votre prochain Precise Shot sera instantanément lancé.',
  }
},
{
  name: {$$: 'Mount Riding'},
...
},
{
  ...
  description: {
    ...
    fr: 'Téléportation au prestidigitateur le plus proche.',
  }
},
{
  name: {$$: 'Tempering'},
...
},
{
  ...
  description: {
    ...
    fr: 'Récoltez les âmes des ennemis proches affectés par Decay, infligeant des dégats et vous octroyant du mana pour chaque âme récoltée.',
  }
},
{
  name: {$$: 'Plaguespreader'},
