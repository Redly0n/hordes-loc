...
export default {
  msg: [
    ...
    },
    {
      ...
      // cs: 'Toto je tvá postava. Zde můžete vidět své vlastní zdraví a manu.'
    },
    {
    ...
    },
    {
      ...
      // cs: 'Toto monstrum je teď tvůj cíl. Jakákoli kouzla, která sešles, budou směrovat na tvůj cíl.'
    },
    {
      en: 'You can attack by pressing the keys on your skillbar. Press <kbd>1</kbd> on your keyboard to attack the monster!'
      // ru: 'Вы можете атаковать, нажимая клавиши на панели навыков. Нажмите <kbd>1</kbd> на клавиатуре, чтобы атаковать монстра!',
    ...
    },
    {
      ...
      //ru: 'Идеально! Продолжайте в том же духе и разберитесь с монстром!',
      // it: 'Perfetto! Continua così e affronta il mostro!',
    ...
    },
    {
      ...
      // ru: 'Хорошая работа. Вы были вознаграждены очками опыта.',
      // it: 'Bel lavoro. Sarai ricompensato con dei punti esperienza.',
    ...
    },
    {
      ...
      // ru: 'Соберите достаточное количество очков опыта, и вы повысите свой уровень.',
      // it: 'Raccogli abbastanza punti esperienza e salirai di livello.',
    ...
    },
    {
      ...
      // ru: 'Вы можете нажать <kbd>Shift</kbd>, чтобы увидеть предметы и монеты на земле. Возьмите какой-нибудь предмет!',
      // it: 'Puoi premere <kbd>Shift</kbd> per vedere gli oggetti e le monete per terra. Racogli un oggetto! ',
    ...
    },
    {
      ...
      // ru: 'Вы подобрали предмет. Откройте свой инвентарь (<kbd>B</kbd>), чтобы увидеть его.',
    ...
    },
    {
      ...
      // ru: 'Здесь вы можете увидеть свои предметы. Размер инвентаря зависит от сумки, которую вы надели.',
      // it: 'Qui puoi vedere i tuoi oggetti. Il numero di slot disponibili dipende dalla borsa che hai equipaggiato.',
    ...
    },
    {
      ...
      // ru: 'Вы можете надеть предметы, щелкнув их правой кнопкой мыши и выбрав "Надеть предмет".',
      // it: 'Puoi equipaggiare gli oggetti facendo clic destro su di essi e selezionando "Equipaggia oggetto".',
      // pt: 'Você pode equipar itens clicando com o botão direito seles e então selecionar "Equipar item".',
      // fr: 'Vous pouvez équiper des items (objets) en cliquant droit dessus et en sélectionnant "Equiper l\'item".',
      // cs: 'Předměty můžeš obléct kliknutím na pravé tlačítko a výběrem "Obléct předmět.'
    },
    {
      en: 'Open your character panel (<kbd>C</kbd>).'
      // ru: 'Откройте панель персонажа (<kbd>C</kbd>).',
    ...
    },
    {
      ...
      // ru: 'Вы можете увидеть все надетые предметы на панели вашего персонажа.',
    ...
    },
    {
      ...
      // ru: 'Затем попробуйте повысить уровень, убивая монстров.',
      // it: 'Adesso prova a salire di livello uccidendo i mostri.',
    ...
    },
    {
      ...
      // ru: 'Вы повысили свой уровень и заработали очки статистики. Снова откройте панель персонажа (<kbd>C</kbd>) опять.',
    ...
    },
    {
      ...
      // ru: 'Далее мы научим вас, как осваивать новые умения. Во-первых, получите уровень 3, чтобы разблокировать новое умение.',
      // it: 'Adesso ti spiegherò come imparare nuove abilità. Primo, raggiungi il livello 3.',
    ...
    },
    {
      ...
      // ru: 'Доступно новое умение. Вам нужно использовать книги, чтобы выучить новые умения.',
      // it: 'Una nuova abilità è disponibile. Devi usare i libri perimparare nuove abilità.',
    ...
    },
    {
      ...
      // ru: 'Соберите несколько предметов и монет. Вам нужно 32 монеты для вашей первой книги. Вы также можете продавать товары торговцу.',
      // it: 'Raccogli alcuni oggetti e monete. Hai bisogno di 32 monete per il tuo primo libro. Puoi anche vendere oggetti al trader.',
    ...
    },
    {
      ...
      // fr: 'Le Trader vend des livres de compétences, et des montures. Faites un clic-droit sur le livre pour l\'acheter.',
    ...
    },
    {
      ...
      // ru: 'Закройте окно торговца, затем откройте панель умений (<kbd>K</kbd>), чтобы просмотреть ваши умения.',
      // it: 'Chiudi la finestra del commerciante, poi apri il tuo pannello delle abilità (<kbd>K</kbd>) per vedere una panoramica delle tue abilità.',
    ...
    },
    {
      ...
      // ru: 'Здесь вы можете увидеть свои умения. Наведите на них курсор для получения дополнительной информации. Умения обычно требуют одного очка навыка, который вы зарабатываете раз в два уровня',
    ...
    },
    {
      ...
      // fr: 'Vous pouvez changer votre set de compétences à tout moment. Ajoutez un point de compétence à votre compétence pour l'activer.',
    },
    {
      en: 'Now press "Apply" to activate your new skill set.'
      // fr: 'Maintenant, appuyez sur "Appliquer" pour activer votre nouveau set de compétences.'
    },
    {
      en: 'You can click and drag a skill into your skillbar. We already did it for you!'
      // ru: 'Вы можете щелкнуть и перетащить умение на панель навыков. Мы уже сделали это за вас!',
      // it: 'Puoi fare clic e trascinare le abilità nella barra abilità. Fatto solo per te!',
    ...
    },
    {
      ...
      // ru: 'Вы многому научились. Вы почти готовы начать свое приключение.',
      // it: 'Hai imparato molto. Sei quasi pronto per iniziare la tua avventura.',
    ...
    },
    {
      ...
      // ru: 'Hordes - это то, в чём присутствует командная работа. Группа может помочь вам повысить ваш уровень.',
      // it: 'Hordes significa lavorare in un party con altri giocatori. Un party può aiutarti a salire di livello.',
    ...
    },
    {
      ...
      // ru: 'Группа игроков может делиться опытом и предметами, что позволит прокачиваться быстрее, чем одиночные игроки.',
      // it: 'Un gruppo di giocatori condividerà esperienza e oggetti, consentendo loro di progredire più velocemente rispetto ai giocatori solitari.',
    ...
    },
    {
      ...
      // ru: 'Вы можете создать или найти группу с помощью интерфейса группы. Нажмите на <kbd>Найти группу</kbd> для автоматического поиска.',
      // it: 'Puoi creare o trovare un party con la relativa interfaccia. Clicca on <kbd>Trova Party</kbd> per cercarne uno.',
    ...
    },
    {
      ...
      // ru: 'Вы также можете пригласить игроков в свою группу, щелкнув правой кнопкой мыши на их панели персонажа или используя команду <kbd>/party invite</kbd>.',
      // it: 'Puoi anche invitare giocatori nel tuo party cliccando il tasto Destro sulla loroicona, o usando il comando <kbd>/partyinvite</kbd>.',
    ...
    },
    {
      ...
      // ru: 'Группы также позволят вам делиться очками славы в PVP-боях.',
      // it: 'Partecipare ad un party ti permetterà anche di condividere punti fama nel combattimento PVP.',
    ...
    },
    {
      ...
      // ru: 'Чтобы заработать славу и предметы (например, корону) для вашего персонажа, необходимо убить игроков другой фракции.',
      // it: 'I giocatori della fazione avversaria possono essere uccisi per guadagnare fama e oggetti (come la corona) per il tuo personaggio.',
    ...
    },
    {
      ...
      // ru: 'Вы также можете продавать предметы другим игрокам. Для этого вы можете посетить купца.',
      // it: 'Puoi anche vendere oggetti ai giocatori. Puoi visitare il Mercante per farlo.',
    ...
    },
    {
      ...
      // ru: 'Любые предметы, которые вы купите у купца, будут отправлены в ваш тайник - хранилище для ваших предметов и золота. Это коричневая коробка, расположенная рядом с купцом.',
      // it: 'Tutti gli oggetti che acquisti dal mercante verranno inviati alla tua scorta, un deposito per i tuoi oggetti e monete. È una scatola marrone situata accanto al mercante.',
    ...
    },
    {
      ...
      // ru: 'Вы найдете руны, убивая монстров. Руны позволят вам улучшить ваши предметы. Для этого посетите кузнеца.',
      // it: 'Troverai le rune quando uccidi i mostri. Le rune ti permetteranno di aggiornare i tuoi oggetti. Visita il fabbro per farlo.',
    ...
    },
    {
      ...
      // ru: 'Важна координация с игроками. Вы можете использовать <kbd>/global</kbd>, <kbd>/party</kbd>, <kbd>/faction</kbd> и <kbd>/clan</kbd>. Нажмите Enter, чтобы пообщаться.',
      // it: 'Il coordinamento con i giocatori è importante. Puoi usare <kbd>/global</kbd>, <kbd>/party</kbd>, <kbd>/faction</kbd> e <kbd>/clan</kbd>. Premi Invio per chattare.',
      // pt: 'A comunicação com outros jogadores é importante. Você pode usar <kbd>/global</kbd>, <kbd>/party</kbd>, <kbd>/faction</kbd> e <kbd>/clan</kbd>. Pressione Enter para conversar.',
      // fr: 'La communication avec les joueurs est importante. Vous pouvez utiliser <kbd>/global</kbd>, <kbd>/party</kbd>, <kbd>/faction</kbd> et <kbd>/clan</kbd>. Appuyez sur Entrer pour parler.',
      // cs: 'Koordinace s hráči je důležitá. Můžeš proto použít chat <kbd>/global</kbd>, <kbd>/party</kbd>, <kbd>/faction</kbd> and <kbd>/clan</kbd>. Stiskni Enter pro chatování.'
    },
    {
      en: 'Type in your greatest battle shout. Then press enter to send your love letter to the world.'
      // ru: 'Введите свой величайший боевой клич. Затем нажмите Enter, чтобы каждый в мире о вас узнал.',
      // it: 'Digita il tuo più grande grido di battaglia. Quindi premi Invio per inviare la tua lettera d\'amore al mondo.',
    ...
    },
    {
      ...
      // ru: 'Видите шестерёнку в правом верхнем углу? Откройте настройки игры.',
      // it: 'Vedi la ruota dentata nell\'angolo in alto a destra? Apri le impostazioni di gioco.',
    ...
    },
    {
      ...
      // ru: 'Здесь вы можете изменить многие вещи, такие как элементы управления, язык или графику.',
      // it: 'Puoi modificare molte cose qui, come i controlli, la lingua o la riduzione della grafica.',
    ...
    },
    {
      ...
      // ru: 'Хорошо, снова закройте настройки.',
    ...
    },
    {
      ...
      // ru: 'Вот и все. Ты сделал это. Ты готов сражаться. Ваша фракция зависит от вас.',
      // it: 'Fatto. ci sei riuscito. Sei pronto per uccidere. La tua fazione dipende da te.',
    ...
    },
    {
      ...
      // ru: 'Удачи, чемпион.',
      // it: 'Buona fortuna, campione.',
      // pt: 'Boa sorte, campeâo',
      // fr: 'Bonne chance, champion.',
      // cs: 'Hodně štěstí šampione.'

    },
    {
      en: 'Congratulations on Lv. 25! You can now enter Headless Landing, a new world. Speak to the Conjurer in your base.'
      // ru: 'Поздравляю с 25-м уровнем! Теперь вы можете войти в Headless Landing, новый мир. Поговорите с чародеем на вашей базе.',
      // it: 'Congratulazioni per il Lv. 25! Ora puoi entrare in Headless Landing, un nuovo mondo. Parla con l\'Evocatore nella tua base.',
